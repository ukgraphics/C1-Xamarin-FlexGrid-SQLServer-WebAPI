...
{
    public partial class grapecitytestdbContext : DbContext
    {
        public grapecitytestdbContext()
        {
        }

        public grapecitytestdbContext(DbContextOptions<grapecitytestdbContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=tcp:grapecitytestdbsrv.database.windows.net,1433;Initial Catalog=grapecitytestdb;Persist Security Info=False;User ID=kuni;Password=Leadtoolsv19;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA5EE685F6");
